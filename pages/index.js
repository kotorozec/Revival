                ...
                <div className={"grid grid-cols-1 md:grid-cols-2 w-full h-full lg:py-10 place-items-center"}>
                    <div className={"place-items-center grid grid-cols-1 relative"}>
                        ...
                        <div className={"w-full grid grid-cols-1 place-items-center"}>
                            <div className={"grid grid-cols-2 sm:grid-cols-3 gap-5 pb-6 xl:w-3/4"}>
                                <div
                                    className={"bg-white rounded-full p-3 flex items-center justify-evenly gap-1 dark:text-gray-800  shadow-xl "}>
                                    <div
                                        className="min-h-[0.7rem] min-w-[0.7rem] bg-gray-800 rounded-full before:content-[''] mx-1"></div>
                                    <h3 className={"text-base w-full text-center"}>{t.MainServicesFirst}</h3>
                                </div>
                                <div
                                    className={"bg-white rounded-full p-3 flex items-center justify-evenly gap-1 dark:text-gray-800  shadow-xl "}>
                                    <div
                                        className="min-h-[0.7rem] min-w-[0.7rem] bg-gray-800 rounded-full before:content-[''] mx-1"></div>
                                    <h3 className={"text-base w-full text-center"}>{t.MainServicesSecond}</h3>
                                </div>
                                <div
                                    className={"bg-white rounded-full p-3 flex items-center justify-evenly gap-1 dark:text-gray-800  shadow-xl "}>
                                    <div
                                        className="min-h-[0.7rem] min-w-[0.7rem] bg-gray-800 rounded-full before:content-[''] mx-1"></div>
                                    <h3 className={"text-base w-full text-center"}>{t.MainServicesThird}</h3>
                                </div>
                                <div
                                    className={"bg-white rounded-full p-3 flex items-center justify-evenly gap-1 dark:text-gray-800  shadow-xl "}>
                                    <div
                                        className="min-h-[0.7rem] min-w-[0.7rem] bg-gray-800 rounded-full before:content-[''] mx-1"></div>
                                    <h3 className={"text-base w-full text-center"}>{t.MainServicesForth}</h3>
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        className="min-h-[0.7rem] min-w-[0.7rem] bg-gray-800 rounded-full before:content-[''] mx-1"></div>
                                    <h3 className={"text-base w-full text-center"}>{t.MainServicesFifth}</h3>
                                </div>
                                <div
                                    className={"bg-white rounded-full p-3 flex items-center justify-evenly gap-1 dark:text-gray-800  shadow-xl "}>
                                    <div
                                        className="min-h-[0.7rem] min-w-[0.7rem] bg-gray-800 rounded-full before:content-[''] mx-1"></div>
                                    <h3 className={"text-base w-full text-center"}>{t.MainServicesSixth}</h3>
                                </div>
                            </div>
                        </div>
