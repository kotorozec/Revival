        ...
        <div className={"max-w-3xl p-6 group"}>
            <article
                ...
                <div className={"w-full flex justify-end duration-500"}>
                    <Link href={`/blog/${slug}`} className={"bg-[#ffa500] px-3 py-2 rounded-lg self-end group-hover:bg-white group-hover:text-gray-800 dark:group-hover:bg-gray-800 dark:group-hover:text-white"}>Zobacz więcej</Link>
                </div>
            </article>
        </div>
